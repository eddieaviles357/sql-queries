...
SELECT app_name AS top_5, reviews
FROM analytics
...
-- another way using subqueries ( better with MAX )
SELECT app_name, price
FROM analytics
...
HAVING min_installs >= 100000
ORDER BY proportion DESC
LIMIT 1;

-- id      | app_name     | category        | rating          | 
-- reviews | size         | min_installs    | price           | content_rating |
